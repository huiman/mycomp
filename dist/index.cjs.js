...
function CRUD(props) {
  ...
  var _useState9 = React.useState(props.pageSize),
  ...
  var _useState27 = React.useState(props.orderBy),
  ...
  function LoadData() {
    ...
    if (props.entity) {
      ...
      Axios__default['default'].post(CRUD_Path, data).then(function (res) {
  ...
  function HandleSave() {
    ...
    Axios__default['default'].post(CRUD_Path, data).then(function (res) {
      ...
      if (res.data.split(":")[0] === "Success") {
        ...
        Swal__default['default'].fire("crud", "The record is saved", "success");
      }
    }).catch(function (err) {
      console.log(err);
    });
      ...
      if (result.value) {
        ...
        Axios__default['default'].post(CRUD_Path, data).then(function (res) {
          ...
          if (res.data.split(":")[0] === "Success") {
            ...
            setSelectedX(null);
            setMode("select");
            Swal__default['default'].fire("Deleted!", "Your file has been deleted.", "success");
          }
        }).catch(function (err) {
          console.log(err);
        });
  ...
  return Mode === "select" ? /*#__PURE__*/React__default['default'].createElement(Show, {
    entity: props.entity,
  ...
  }) : Mode === "new" || Mode === "update" ? /*#__PURE__*/React__default['default'].createElement(Form, {
    mode: Mode,
    entity: props.entity,
    primaryKey: PrimaryKey,
    options: Options,
...
var Show = function Show(props) {
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    name: "plus"
  }), " new ", props.entity))), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "row"
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    id: "main",
    className: "col-sm-12"
  ...
  }, props.searchFields ? /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Input, {
    size: "mini",
    name: "searchKey",
  ...
  }) : null, /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Pagination, {
    size: "mini",
  ...
  }), /*#__PURE__*/React__default['default'].createElement("tbody", null, props.loading ? /*#__PURE__*/React__default['default'].createElement("tr", null, /*#__PURE__*/React__default['default'].createElement("td", null, /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Dimmer, {
    active: true
  }, /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Loader, {
    content: "Loading"
  })))) : /*#__PURE__*/React__default['default'].createElement(TableData, {
    fields: props.fields,
    primaryKey: props.primaryKey,
    data: props.data,
    options: props.options,
    HandleEdit: props.HandleEdit
  }))), /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Pagination, {
    size: "mini",
    boundaryRange: 3 // defaultActivePage={1}
    ,
    activePage: props.page,
...
var Header = function Header(props) {
  return /*#__PURE__*/React__default['default'].createElement("h1", null, props.title);
};

var TableHeader = function TableHeader(props) {
  return /*#__PURE__*/React__default['default'].createElement("thead", {
    className: "thead-dark"
  }, /*#__PURE__*/React__default['default'].createElement("tr", null, props.fields ? props.fields.filter(function (f) {
  ...
  }) : null, /*#__PURE__*/React__default['default'].createElement("th", {
...
var TableData = function TableData(props) {
  ...
  return props.data ? props.data.map(function (dat, x) {
    ...
    }) : null, /*#__PURE__*/React__default['default'].createElement("td", {
      className: "text-right"
    }, /*#__PURE__*/React__default['default'].createElement("div", {
...
var Form = function Form(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    id: "main",
    className: "col-sm-3 text-right"
  }, props.mode === "update" ? /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Button, {
    icon: true,
    color: "red",
    size: "small",
    onClick: function onClick(e) {
    ...
    name: "delete"
  }), " delete") : null)), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "row"
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    id: "main",
    className: "col-sm-12"
    ...
    return /*#__PURE__*/React__default['default'].createElement(FormItem, {
      mode: props.mode,
      field: field,
      option: option,
      key: "FormItem" + x,
  ...
  }) : null, /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Button, {
    icon: true,
    color: "grey",
    size: "small",
    onClick: function onClick(e) {
    ...
    name: "angle left"
  }), " back to list"), /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Button, {
    icon: true,
    color: "green",
    size: "small",
    onClick: function onClick(e) {
...
var FormItem = function FormItem(props) {
  return props.field.type === "string" ? /*#__PURE__*/React__default['default'].createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/React__default['default'].createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  }, props.field.fieldName), /*#__PURE__*/React__default['default'].createElement("input", {
    type: "text",
  ...
  })) : props.field.type == "text" ? /*#__PURE__*/React__default['default'].createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/React__default['default'].createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  }, props.field.fieldName), /*#__PURE__*/React__default['default'].createElement("textarea", {
    type: "text",
  ...
  })) : props.field.type == "boolean" ? /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    htmlFor: props.field.fieldName
  }, props.field.fieldName)) : props.field.type == "integer" || props.field.type == "smallint" || props.field.type == "bigint" || props.field.type == "float" || props.field.type == "decimal" ? /*#__PURE__*/React__default['default'].createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/React__default['default'].createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  ...
  })) : props.field.type == "datetime" ? /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  }, props.field.fieldName), /*#__PURE__*/React__default['default'].createElement(semanticUiCalendarReact.DateTimeInput, {
    ...
    clearable: true
  })) : props.field.type == "date" ? /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  }, props.field.fieldName), /*#__PURE__*/React__default['default'].createElement(semanticUiCalendarReact.DateInput, {
    name: props.field.fieldName,
    placeholder: "Date",
    value: props.record[props.field.fieldName],
    iconPosition: "left",
    onChange: props.HandleChangeDateTime,
    clearable: true
  })) : props.field.type == "time" ? /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  }, props.field.fieldName), /*#__PURE__*/React__default['default'].createElement(semanticUiCalendarReact.TimeInput, {
    name: props.field.fieldName,
    placeholder: "Time",
    value: props.record[props.field.fieldName],
    iconPosition: "left",
    onChange: props.HandleChangeDateTime,
    clearable: true
  })) : props.field.type == "json" ? /*#__PURE__*/React__default['default'].createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/React__default['default'].createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  ...
  })) : props.field.type.split(":")[0] == "ManyToOne" ? /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Select, {
    name: props.field.fieldName,
    placeholder: props.field.fieldName,
    options: props.option,
    value: props.record[props.field.fieldName],
    onChange: props.HandleChangeSelect
  })) : /*#__PURE__*/React__default['default'].createElement("div", null, "no match");
};
