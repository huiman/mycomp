...
function CRUD(props) {
  ...
  var _useState9 = (0, _react.useState)(props.pageSize),
  ...
  var _useState27 = (0, _react.useState)(props.orderBy),
  ...
  function LoadData() {
    ...
    if (props.entity) {
      ...
      _axios.default.post(CRUD_Path, data).then(function (res) {
  ...
  function HandleEdit(x) {
    ...
    setSelectedX(x);
    setSelectedRecord(_objectSpread({}, Date[x]));
    setMode("update");
  }
  ...
  function HandleSave() {
    ...
    _axios.default.post(CRUD_Path, data).then(function (res) {
      ...
      if (res.data.split(":")[0] === "Success") {
        ...
        _sweetalert.default.fire("crud", "The record is saved", "success");
      }
    }).catch(function (err) {
      console.log(err);
    });
  ...
  return Mode === "select" ? /*#__PURE__*/_react.default.createElement(Show, {
    entity: props.entity,
  ...
  }) : Mode === "new" || Mode === "update" ? /*#__PURE__*/_react.default.createElement(Form, {
    mode: Mode,
    entity: props.entity,
    primaryKey: PrimaryKey,
    options: Options,
...
var Show = function Show(props) {
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    name: "plus"
  }), " new ", props.entity))), /*#__PURE__*/_react.default.createElement("div", {
    className: "row"
  }, /*#__PURE__*/_react.default.createElement("div", {
    id: "main",
    className: "col-sm-12"
  ...
  }, props.searchFields ? /*#__PURE__*/_react.default.createElement(_semanticUiReact.Input, {
    size: "mini",
    name: "searchKey",
  ...
  }) : null, /*#__PURE__*/_react.default.createElement(_semanticUiReact.Pagination, {
    size: "mini",
  ...
  }), /*#__PURE__*/_react.default.createElement("tbody", null, props.loading ? /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, /*#__PURE__*/_react.default.createElement(_semanticUiReact.Dimmer, {
    active: true
...
var TableHeader = function TableHeader(props) {
  ...
  }, /*#__PURE__*/_react.default.createElement("tr", null, props.fields ? props.fields.filter(function (f) {
  ...
  }) : null, /*#__PURE__*/_react.default.createElement("th", {
...
var Form = function Form(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    id: "main",
    className: "col-sm-3 text-right"
  }, props.mode === "update" ? /*#__PURE__*/_react.default.createElement(_semanticUiReact.Button, {
    icon: true,
    color: "red",
    size: "small",
    onClick: function onClick(e) {
    ...
    name: "delete"
  }), " delete") : null)), /*#__PURE__*/_react.default.createElement("div", {
    className: "row"
  }, /*#__PURE__*/_react.default.createElement("div", {
    id: "main",
    className: "col-sm-12"
  ...
  }) : null, /*#__PURE__*/_react.default.createElement(_semanticUiReact.Button, {
    icon: true,
    color: "grey",
    size: "small",
    onClick: function onClick(e) {
    ...
    name: "angle left"
  }), " back to list"), /*#__PURE__*/_react.default.createElement(_semanticUiReact.Button, {
    icon: true,
    color: "green",
    size: "small",
    onClick: function onClick(e) {
...
var FormItem = function FormItem(props) {
  return props.field.type === "string" ? /*#__PURE__*/_react.default.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/_react.default.createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  }, props.field.fieldName), /*#__PURE__*/_react.default.createElement("input", {
    type: "text",
  ...
  })) : props.field.type == "text" ? /*#__PURE__*/_react.default.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/_react.default.createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  }, props.field.fieldName), /*#__PURE__*/_react.default.createElement("textarea", {
    type: "text",
  ...
  })) : props.field.type == "boolean" ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    htmlFor: props.field.fieldName
  }, props.field.fieldName)) : props.field.type == "integer" || props.field.type == "smallint" || props.field.type == "bigint" || props.field.type == "float" || props.field.type == "decimal" ? /*#__PURE__*/_react.default.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/_react.default.createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  ...
  })) : props.field.type == "datetime" ? /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  }, props.field.fieldName), /*#__PURE__*/_react.default.createElement(_semanticUiCalendarReact.DateTimeInput, {
    ...
    clearable: true
  })) : props.field.type == "date" ? /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  }, props.field.fieldName), /*#__PURE__*/_react.default.createElement(_semanticUiCalendarReact.DateInput, {
    name: props.field.fieldName,
    placeholder: "Date",
    value: props.record[props.field.fieldName],
    iconPosition: "left",
    onChange: props.HandleChangeDateTime,
    clearable: true
  })) : props.field.type == "time" ? /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  }, props.field.fieldName), /*#__PURE__*/_react.default.createElement(_semanticUiCalendarReact.TimeInput, {
    name: props.field.fieldName,
    placeholder: "Time",
    value: props.record[props.field.fieldName],
    iconPosition: "left",
    onChange: props.HandleChangeDateTime,
    clearable: true
  })) : props.field.type == "json" ? /*#__PURE__*/_react.default.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/_react.default.createElement("label", {
    className: "control-label required",
    htmlFor: props.field.fieldName
  ...
  })) : props.field.type.split(":")[0] == "ManyToOne" ? /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_semanticUiReact.Select, {
    name: props.field.fieldName,
    placeholder: props.field.fieldName,
    options: props.option,
    value: props.record[props.field.fieldName],
    onChange: props.HandleChangeSelect
  })) : /*#__PURE__*/_react.default.createElement("div", null, "no match");
};

//# sourceMappingURL=CRUD.jsx.map